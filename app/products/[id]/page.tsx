...
import { Product, getProduct, calculateDiscountedPrice } from '@/lib/storage';
import { formatProductOrderMessage, openWhatsApp } from '@/lib/whatsapp';
...
export default function ProductDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const orderViaWhatsApp = () => {
    ...
    const message = formatProductOrderMessage(product.name, price, quantity);
